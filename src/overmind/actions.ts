...
const messages: Message[] = [
  ...
  { code: 'R02', message: 'Dit adres is al geregistreerd. Als je je wachtwoord bent vergeten, kun je een nieuw wachtwoord opvragen.' },
...
export const changePassword: AsyncAction<PasswordData> = async ({ effects, state }, passwordData) => {
  ...
  if (pwData.data.success) {
    state.error.login = 'Je toegangscode is gewijzigd!';
  }
